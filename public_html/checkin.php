			...
			<div class="row">
				<div class="panel panel-default" style="width:100%">
					...
					<div class="panel-body" style="height: calc(50vh + 100px);">
						...
						<h2>Enter Check In Information</h2>
						<div class="buttonHolder">
							<form method="post">
								...
								<select name="checkinitem" class="utselect" data-placeholder="Select an Item to Check In">
									<option></option>
									<?php 
									$sql = mysql_query("SELECT `Name` FROM `Equipment` WHERE `Checked In/Out` = '1'");
									while ($row = mysql_fetch_array($sql)){
									echo "<option value = \"" .$row['Name']. "\">" . $row['Name'] . "</option>";
									}
									?>
								...
								<input type="submit" name="checkin" value="Check In" class="btn btn-warning active"/>
							</form>
						</div>
					</div>
